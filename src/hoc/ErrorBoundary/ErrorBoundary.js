...
import { defaultErrorMessage } from '../../store/utility';
...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.props.err) {
      return <h1 style={{ color: 'black' }}>{defaultErrorMessage}</h1>;
    }
...
const mapDispatchToProps = dispatch => ({
   ...
   */
  onError: errorMessage => dispatch(actionCreators.errorOccured(errorMessage)),
});
